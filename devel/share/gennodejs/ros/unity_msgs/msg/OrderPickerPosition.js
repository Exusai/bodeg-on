...
class OrderPickerPosition {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new OrderPickerPosition(null);
  ...
  static datatype() {
    ...
    return 'unity_msgs/OrderPickerPosition';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new OrderPickerPosition(null);
...
module.exports = OrderPickerPosition;
